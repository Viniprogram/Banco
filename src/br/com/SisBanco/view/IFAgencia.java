 ...
 * @author Vinicius
 */
public class IFAgencia extends javax.swing.JInternalFrame implements ChangeListener{
    
    /**
     * Creates new form IFObrigacoes
     */
    public IFAgencia() {
        initComponents();
        atualizarGrade();
    ...
    private void initComponents() {
        ...
        try {
            ...
            ftCodigo = new javax.swing.JFormattedTextField(fmtNumero);
        ...
        setPreferredSize(new java.awt.Dimension(677, 312));
        ...
        jlCodigo.setText(" Número da Agência:");
        ...
        jlDescricao.setText(" Nome da Agência:");
        ...
        pnCadastroLayout.setHorizontalGroup(
            ...
            .addGroup(pnCadastroLayout.createSequentialGroup()
                ...
                .addGroup(pnCadastroLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    .addComponent(ftCodigo, javax.swing.GroupLayout.Alignment.LEADING)
        ...
        pnCadastroLayout.setVerticalGroup(
            ...
            .addGroup(pnCadastroLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(pnCadastroLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(tfDescricao, javax.swing.GroupLayout.PREFERRED_SIZE, 28, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(ftCodigo, javax.swing.GroupLayout.PREFERRED_SIZE, 28, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(tpAbas, javax.swing.GroupLayout.Alignment.TRAILING)
        );
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(tpAbas, javax.swing.GroupLayout.DEFAULT_SIZE, 256, Short.MAX_VALUE)
        );
    ...
    protected  void atualizarGrade(){
        try {
            ResultSet rs = new AgenciaDAO().carregarGrade();
            tbDados.setModel(new ApModeloGrade(rs,new String[]{"Número", "Nome da Agência"}));
            tbDados.getColumnModel().getColumn(0).setPreferredWidth(400);
    ...
    class MouseHandler extends MouseAdapter {
        ...
        public void mouseReleased(MouseEvent e) {
            ...
            try {
                ...
                showMessageDialog(IFAgencia.this, ex.getMessage(), "Erro", ERROR_MESSAGE);
            }
        }
    }
    ...
    protected void incluir(){
        ...
        a.setNumero(ftCodigo.getText());
        a.setNome(tfDescricao.getText());
                    
            new AgenciaDAO().cadastrarAgencia(a);
            atualizarGrade();
            tpAbas.setSelectedIndex(0);
        } catch (Exception ex) {
            showMessageDialog(this, "Erro ao incluir agência!" + ex.getMessage(),"Erro",ERROR_MESSAGE);
        }                
    }
    ...
    protected void alterar(){
        ...
        a.setNome(tfDescricao.getText());
            ...
            new AgenciaDAO().alterarAgencia(a);
            atualizarGrade();
            tpAbas.setSelectedIndex(0);
        } catch (Exception ex) {
    ...
    protected void excluir(){
        try {
            new AgenciaDAO().excluirAgencia(ftCodigo.getText());
    ...
    protected void carregarRegistro(String codigo)throws Exception{
        Agencia a = new AgenciaDAO().consultarAgencia(codigo);
        ftCodigo.setText(String.valueOf(a.getNumero()));
        tfDescricao.setText(a.getNome());        
    }
    ...
    private void btExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btExcluirActionPerformed
        ...
        if (evt.getSource() == btExcluir) {
            int opcao = showOptionDialog(this, "Tem certeza que deseja excluir essa agência?", "Confirme", 0,
